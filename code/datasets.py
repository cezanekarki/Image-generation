...
class DatasetLoadTransform(data.Dataset):
    ...
    def load_class_id(self, data_dir, total_num):
        if os.path.isfile(data_dir + '/class_info.pkl'):
            with open(data_dir + '/class_info.pkl', 'rb') as f:
    ...
    def __getitem__(self, index):
        ...
        img_name = '%s/%s.jpg' % (self.image_dir, key)
